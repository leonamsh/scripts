...
echo ""
sudo pacman -S curl unzip git jq --noconfirm --needed
...
sudo pacman -S mesa lib32-mesa vulkan-radeon lib32-vulkan-radeon libva-mesa-driver libva-utils --noconfirm --needed
sudo pacman -S alacritty --noconfirm --needed
sudo pacman -S goverlay --noconfirm --needed
sleep 2s
echo "#--------------------Instalando pacotes AUR--------------------#"
echo ""
pamac install yay
pacman -S yay --noconfirm --needed
yay -S tabby --noconfirm --needed
yay -S visual-studio-code-bin --noconfirm --needed
yay -S firefox-nightly-bin firefox-nightly-i18n-pt-br --noconfirm --needed
sleep 2s
