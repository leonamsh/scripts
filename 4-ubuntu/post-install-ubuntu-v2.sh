...
install_apt_packages "Pacotes essenciais" \
    ...
    xfce4-power-manager lxappearance flameshot libssl-dev libsqlite3-dev zlib1g-dev libbz2-dev \
    libreadline-dev libffi-dev liblzma-dev tk-dev npm nodejs"
...
install_apt_packages "Bibliotecas e Ferramentas de Desenvolvimento Adicionais" \
    "gnupg ca-certificates gcc-multilib g++-multilib cmake pkg-config \
...
install_apt_packages "Bibliotecas Wine" \
    "wine wine-stable winetricks libvulkan1 libvulkan1:i386 vulkan-tools mesa-vulkan-drivers \
     libgif7:i386 libgnutls30:i386 libv4l-0:i386 \
...
# --- Flatpak ---
log_section "Configurando Flatpak"
...
run_command "git clone --depth=1 https://github.com/zsh-users/zsh-autosuggestions ${ZSH_CUSTOM:-~/.oh-my-zsh/custom}/plugins/zsh-autosuggestions"
run_command "git clone --depth=1 https://github.com/zsh-users/zsh-syntax-highlighting ${ZSH_CUSTOM:-~/.oh-my-zsh/custom}/plugins/zsh-syntax-highlighting"
